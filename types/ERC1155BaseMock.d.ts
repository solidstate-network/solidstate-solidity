...
interface ERC1155BaseMockInterface extends ethers.utils.Interface {
  functions: {
    ...
    "safeMintBatch(address,uint256[],uint256[])": FunctionFragment;
    "safeTransfer(address,address,address,uint256,uint256,bytes)": FunctionFragment;
    "safeTransferBatch(address,address,address,uint256[],uint256[],bytes)": FunctionFragment;
    "safeTransferFrom(address,address,uint256,uint256,bytes)": FunctionFragment;
    "setApprovalForAll(address,bool)": FunctionFragment;
    "supportsInterface(bytes4)": FunctionFragment;
    "transfer(address,address,address,uint256,uint256,bytes)": FunctionFragment;
    "transferBatch(address,address,address,uint256[],uint256[],bytes)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "safeTransferBatch",
    values: [string, string, string, BigNumberish[], BigNumberish[], BytesLike]
  ): string;
  encodeFunctionData(
...
export class ERC1155BaseMock extends BaseContract {
