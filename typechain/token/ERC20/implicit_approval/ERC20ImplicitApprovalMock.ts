...
export interface ERC20ImplicitApprovalMockInterface extends utils.Interface {
  functions: {
    '__burn(address,uint256)': FunctionFragment;
    '__isImplicitlyApproved(address)': FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | '__isImplicitlyApproved'
      | '__isImplicitlyApproved(address)'
      | '__mint'
  ...
  encodeFunctionData(
    functionFragment: '__isImplicitlyApproved',
    values: [string],
  ): string;
  encodeFunctionData(
    functionFragment: '__isImplicitlyApproved(address)',
    values: [string],
  ): string;
  encodeFunctionData(
...
export interface ERC20ImplicitApprovalMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC20ImplicitApprovalMockInterface;
