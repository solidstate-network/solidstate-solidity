...
export interface ERC20BaseMockInterface extends utils.Interface {
  functions: {
    '__approve(address,address,uint256)': FunctionFragment;
    '__burn(address,uint256)': FunctionFragment;
    '__mint(address,uint256)': FunctionFragment;
    '__transfer(address,address,uint256)': FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      | '__approve'
      | '__approve(address,address,uint256)'
      | '__burn'
  ...
  encodeFunctionData(
    functionFragment: '__approve(address,address,uint256)',
    values: [string, string, BigNumberish],
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: '__transfer(address,address,uint256)',
    values: [string, string, BigNumberish],
  ): string;
  encodeFunctionData(
...
export interface ERC20BaseMock extends BaseContract {
