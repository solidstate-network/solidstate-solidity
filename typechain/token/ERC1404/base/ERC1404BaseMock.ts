...
export interface ERC1404BaseMockInterface extends utils.Interface {
  functions: {
...
export interface ERC1404BaseMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC1404BaseMockInterface;
