...
contract Timelock is ITimelock {
    ...
    function GRACE_PERIOD () override virtual public view returns (days) {
        return TimelockStorage.layout().GRACE_PERIOD;
    }

    function MINIMUM_DELAY () override virtual public view returns (days) {
        return TimelockStorage.layout().MINIMUM_DELAY;
    }

    function MAXIMUM_DELAY () override virtual public view returns (days) {
        return TimelockStorage.layout().MAXIMUM_DELAY;
    }

    function admin () override virtual public view returns (address) {
        return TimelockStorage.layout().admin;
    }

    function pendingAdmin () override virtual public view returns (address) {
    ...
    function queuedTransactions () override virtual public view returns (mapping (bytes32 => bool)) {
        return TimelockStorage.layout().queuedTransactions;
    }
    ...
    constructor(address admin_, uint delay_) public {
        ...
        TimelockStorage.Layout storage l = Timelock.layout();
