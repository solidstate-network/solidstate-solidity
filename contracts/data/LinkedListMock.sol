...
contract LinkedListMock {
    ...
    function getAdjacent(uint256 node, bool direction)
        external
        view
        returns (uint256)
    {
    ...
    function insertAfter(uint256 node, uint256 newNode)
        external
        returns (bool)
    {
    ...
    function insertBefore(uint256 node, uint256 newNode)
        external
        returns (bool)
    {
