...
describe('SafeOwnable', () => {
  ...
  let instance: __hh_exposed_SafeOwnable;
  ...
  beforeEach(async () => {
    instance = await new __hh_exposed_SafeOwnable__factory(owner).deploy();
  ...
  describe('__internal', () => {
    describe('#_nomineeOwner()', () => {
      it('returns nominee owner address', async () => {
        expect(await instance.__hh_exposed__nomineeOwner.staticCall()).to.equal(
          ethers.ZeroAddress,
        );
    ...
    describe('#_acceptOwnership()', () => {
      it('sets message sender as owner', async () => {
        ...
        await instance.connect(nomineeOwner).__hh_exposed__acceptOwnership();
      ...
      it('sets nominee owner to zero address', async () => {
        await instance.__hh_exposed__setNomineeOwner(nomineeOwner.address);
    ...
    describe('#_transferOwnership(address)', () => {
      it('sets nominee owner to given address', async () => {
        await instance.__hh_exposed__transferOwnership(nomineeOwner.address);
