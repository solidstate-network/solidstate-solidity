  ...
  describe('::ECDSAMultisigWallet', function () {
    ...
    describe('#isInvalidNonce', function () {
      ...
      it('returns true for used nonce', async function () {
        ...
        await instance['callWithSignatures(address,bytes,uint256,uint256[],bytes[])'](
          target,
          data,
          value,
          [nonce],
    ...
    describe('#callWithSignatures', function () {
      ...
      it('transfers value to target address', async function () {
        ...
        await expect(
          async function () {
            return instance['callWithSignatures(address,bytes,uint256,uint256[],bytes[])'](
              target,
              data,
              value,
              [nonce],
      ...
      it('forwards return data from called function', async function () {
        ...
        expect(
          ethers.utils.defaultAbiCoder.decode(
            ...
            await instance.callStatic['callWithSignatures(address,bytes,uint256,uint256[],bytes[])'](
              target,
              data,
              value,
              [nonce],
      ...
      describe('reverts if', function () {
        it('target contract reverts', async function () {
          ...
          await expect(
            instance.callStatic['callWithSignatures(address,bytes,uint256,uint256[],bytes[])'](
              target,
              data,
              value,
              [nonce],
